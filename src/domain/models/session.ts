...
export class Session {
  ...
  getLatestPlan(): unknown | null {
    // TODO: stage 1 — 逆序遍历 this.events
    // 1. for (let i = this.events.length - 1; i >= 0; i--)
    // 2.   if (this.events[i].type === 'plan') return (this.events[i] as PlanEvent).plan
    // 3. return null
    throw new Error('TODO: stage 1 — getLatestPlan')
  }
}
...
export function createSession(
  ...
  // TODO: stage 1 — return new Session(data)
  throw new Error('TODO: stage 1 — createSession')
}
